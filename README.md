...
Self-hosted infrastructure enthusiast with a strong focus on Linux, automation, networking, IoT and resilient system architecture.
I like systems that explain themselves through metrics, recover cleanly from failure and do not require a mouse to survive.

Working across Debian/Linux administration, Proxmox VE, Ceph, ZFS, Docker/LXC, Windows Server, Active Directory, backup/recovery, monitoring and infrastructure automation. My preferred stack is: CLI-first.


Interested in resilient storage, network segmentation, sensor-driven control loops, API workflows, local AI tooling, ESP32 experiments and small devices that quietly make infrastructure smarter. 🐧⚙️📡
...
* MQTT-style event flows, telemetry, local dashboards and sensor-driven control loops
